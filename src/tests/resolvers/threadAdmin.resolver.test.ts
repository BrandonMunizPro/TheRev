...
describe('ThreadAdminResolver', () => {
  ...
  beforeEach(() => {
    mockThreadAdminModel = new ThreadAdminModel() as jest.Mocked<ThreadAdminModel>;
  ...
  describe('grantThreadAdmin', () => {
    it('should throw error when user is not authenticated', async () => {
      ...
      await expect(threadAdminResolver.grantThreadAdmin(data, unauthenticatedContext))
    ...
    it('should grant thread admin successfully', async () => {
      ...
      const result = await threadAdminResolver.grantThreadAdmin(data, mockContext);

      expect(mockThreadAdminModel.grantAdmin).toHaveBeenCalledWith(data, 'testUser1');
    ...
    it('should handle errors from model', async () => {
      ...
      await expect(threadAdminResolver.grantThreadAdmin(data, mockContext))
  ...
  describe('revokeThreadAdmin', () => {
    it('should throw error when user is not authenticated', async () => {
      ...
      await expect(threadAdminResolver.revokeThreadAdmin(data, unauthenticatedContext))
        .rejects.toThrow('Not authenticated');
    });
    ...
    it('should revoke thread admin successfully', async () => {
      ...
      const result = await threadAdminResolver.revokeThreadAdmin(data, mockContext);

      expect(mockThreadAdminModel.revokeAdmin).toHaveBeenCalledWith(data, 'testUser1');
    ...
    it('should handle errors from model', async () => {
      ...
      await expect(threadAdminResolver.revokeThreadAdmin(data, mockContext))
        .rejects.toThrow('Permission denied');
    });
  });
  ...
  describe('threadAdmins', () => {
    it('should throw error when user is not authenticated', async () => {
      ...
      await expect(threadAdminResolver.threadAdmins(data, unauthenticatedContext))
        .rejects.toThrow('Not authenticated');
    });
    ...
    it('should return list of thread admins', async () => {
      ...
      expect(mockThreadAdminModel.listAdminsForThread).toHaveBeenCalledWith(data, 'testUser1');
    ...
    it('should handle errors from model', async () => {
      ...
      await expect(threadAdminResolver.threadAdmins(data, mockContext))
        .rejects.toThrow('Permission denied');
    });
  });
  ...
  describe('myAdminThreads', () => {
    it('should throw error when user is not authenticated', async () => {
      ...
      await expect(threadAdminResolver.myAdminThreads(unauthenticatedContext))
        .rejects.toThrow('Not authenticated');
    });
    ...
    it('should return list of threads where user is admin', async () => {
      ...
      expect(mockThreadAdminModel.listThreadsForUser).toHaveBeenCalledWith('testUser1');
    ...
    it('should handle errors from model', async () => {
      ...
      await expect(threadAdminResolver.myAdminThreads(mockContext))
