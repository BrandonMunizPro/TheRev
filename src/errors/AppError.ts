...
export enum ErrorCode {
  ...
  AI_TASK_NOT_FOUND = 1601,
  AI_PROVIDER_UNAVAILABLE = 1602,
  AI_ACCOUNT_NOT_FOUND = 1603,
  AI_RATE_LIMIT_EXCEEDED = 1604,
  AI_CLASSIFICATION_FAILED = 1605,
  AI_TASK_FAILED = 1606,
  AI_TASK_TIMEOUT = 1607,
  AI_INVALID_INTENT = 1608,
  AI_PROVIDER_ERROR = 1609,
}
